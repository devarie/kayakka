  ...
  return (
    <div className={classes.root}>
      <AppBar
        // maxwidth="lg"
        position="sticky"
        style={{ background: 'linear-gradient(45deg, rgba(245, 229, 27, 1) 30%,rgba(255, 255, 126, 1)  90%)' }}
      >
        <Toolbar>
          ...
          {/* {isMobile ? ( */}
          <>
            <IconButton edge="end" className={classes.menuButton} color="primary" aria-label="menu" onClick={handleMenu}>
              <MenuIcon />
            </IconButton>
            <Menu
              id="menu-appbar"
